...
⭐ **数えた基準を明記する。**この節は `v1.0.0` … **`63cff8b`** の範囲を数えたものである。
...
2026-09-26 に `v1.0.0` … `63cff8b` を改めて1本ずつ数え直し、計上漏れ（PR #792）を足した
（全数表は PR __THIS_PR__ の本文）。

🔴 **`63cff8b` までの範囲で、計上を保留しているものが在る。**PR #811 / #813 / #815
...
【実測 2026-09-26】`git diff 7987de4..63cff8b -- scripts/__snapshots__/public-api/` の削除行も、
