...
/**
 * Issue #579 / ADR 0315: `tick()` の `consolidate` ジョブハンドラ（`processConsolidateJob`、
 ...
 */
describe("processConsolidateJob は tick() 経由で種の subjectId に近傍探索を絞る（Issue #579 / ADR 0315、本物の Postgres）", () => {
  afterAll(async () => {
