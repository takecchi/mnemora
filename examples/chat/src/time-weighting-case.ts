 ...
 * `RecallQuery.timeWeighting`（`"legacy"` | `"eventAwareFreshness"`、ADR 0295）の
 * 違いは出ない（`docs/decisions/0295-time-weighting-policy-opt-in.md` §1 の
 ...
 *   ADR 0295 が直そうとしている二重減衰そのものが起きる場面。
 * - `"old-event-not-outrank-new"`（類型B）: 両方の記憶に `occurredAt` がある場合、
 *   古い出来事が新しい出来事より上位に来てはいけない。ADR 0295 の式は
