...
### OpenAI 実埋め込みの追加 arm（Issue #109 後半、[ADR 0315](../../docs/decisions/0315-openai-embedding-false-positive-ceiling.md)）
...
[ADR 0315](../../docs/decisions/0315-openai-embedding-false-positive-ceiling.md) に記録して
