...
[docs/north-star.md](./docs/north-star.md)「目指す姿」の
「知らないことを、知らないと言える。——『見つからなかった』と『探していない』を、
同じ顔で返さない」は、**`mnemora`（製品）が使う側に対して満たすべき姿**であって、
**書き手・担い手が自分の調査手続きに当て直した版ではない。**この節が足すのは後者
——**同じ言葉が、別の宛先（書き手の調査手続き）にも効くことを明示する。**
