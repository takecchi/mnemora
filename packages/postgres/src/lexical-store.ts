 ...
 *
 * **`1` を足した理由（[Issue #394](../../../docs/decisions/0307-lexical-rank-length-normalization.md)、
 * ADR 0307）**: `32` だけだと `rank` に**内容由来の分解能が無い**——クエリ語が本文中の
 ...
 * 持ち込む理由が無い。ADR 0307「測定」節に、この2案を含む実測値を残してある。
 *
