...
export interface Memory {
  ...
  /**
   * 活動時計（[ADR 0158](../../../docs/decisions/0158-decay-activity-clock.md)）の3つ組。
   ...
   * 沈まない」**を意味する（ADR 0158 決めたこと4）。`decay_clock` が `'wall'` のまま
...
export const MemorySchema = z.object({
  ...
  // ADR 0158: 活動時計の3つ組。3つとも省略可能——`Memory.decayBaseSeq` の doc コメント参照。
