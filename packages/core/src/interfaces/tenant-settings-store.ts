 ...
 * [ADR 0304](../../../docs/decisions/0304-taxonomy-labels.md)（Issue #201）で古くなった。**
...
export interface TenantSettingsStore {
   ...
   * PR-A の時点では観測できる違いが無い——ADR 0304「決めたこと」参照）。
   */
 ...
 * [ADR 0304](../../../docs/decisions/0304-taxonomy-labels.md)。
