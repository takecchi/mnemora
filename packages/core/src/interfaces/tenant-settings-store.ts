 ...
 * [ADR 0305](../../../docs/decisions/0305-taxonomy-labels.md)（Issue #201）で古くなった。**
...
export interface TenantSettingsStore {
   ...
   * PR-A の時点では観測できる違いが無い——ADR 0305「決めたこと」参照）。
   */
 ...
 * [ADR 0305](../../../docs/decisions/0305-taxonomy-labels.md)。
