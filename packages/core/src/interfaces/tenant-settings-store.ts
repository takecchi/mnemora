 ...
 * Issue #201、[ADR 0310](../../../docs/decisions/0310-taxonomy-labels.md)）。
 *
 ...
 * [ADR 0310](../../../docs/decisions/0310-taxonomy-labels.md)（Issue #201）で古くなった。**
...
export interface TenantSettingsStore {
   ...
   * PR-A の時点では観測できる違いが無い——ADR 0310「決めたこと」参照）。
   */
 ...
 * [ADR 0310](../../../docs/decisions/0310-taxonomy-labels.md)。
