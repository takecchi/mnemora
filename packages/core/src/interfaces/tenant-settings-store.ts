 ...
 * [ADR 0313](../../../docs/decisions/0313-taxonomy-labels.md)（Issue #201）で古くなった。**
...
export interface TenantSettingsStore {
   ...
   * PR-A の時点では観測できる違いが無い——ADR 0313「決めたこと」参照）。
   */
 ...
 * [ADR 0313](../../../docs/decisions/0313-taxonomy-labels.md)。
