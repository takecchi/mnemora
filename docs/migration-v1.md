...
⭐ **【実測 2026-09-19、`origin/main` = `420e0f4`】`v0.4.0` → `v1.0.0` の世代には、まだ1件も無い。**
`git diff --stat v0.4.0..420e0f4 -- scripts/__snapshots__/public-api/` は**差分を返さない**。
...
（⚠ **`8`〜`11` が `v0.2.0` → `v0.3.0`、`12`〜`17` が `v0.3.0` → `v0.4.0` の分であり、**
**🔴 どちらも出荷済みである。`v0.4.0` → `v1.0.0` の分は、いまのところ無い**）:
