...
⛔ **[CHANGELOG.md](../CHANGELOG.md) の `[1.0.0]` へ送らないこと**——同節は `v0.2.0`…**`4b92134`** の
範囲を pin しており（節自身がそう名乗っている）、**その pin より後に着地した破壊的変更を持っていない。**
...
⚠ **`CHANGELOG.md` はこの3件をいまも `[1.0.0]`（未リリース）の節に置いている**——同節が pin する
`v0.2.0`…`4b92134` の範囲の中では正しいが、⛔ **「`v1.0.0` で初めて効く」という意味ではない。**
