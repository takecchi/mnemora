...
- ADR 0146 は `recall()` に「連想枠」を足した。**新しい「似ている」の定義を作っていない**
...
- ⛔ **ただし、ADR 0146 が「採らなかった案」として落とした
...
- ⚠ **⟹ 本項目が [Issue #204](https://github.com/takecchi/mnemora/issues/204) の前提であることも変わっていない。**
  **#204 は依然として着手できない。**ADR 0146 は #204 を1歩も前進させていない
  （#204 自身が「『聞かれていないことを、自分から思い出す』の**自分で作る**ほうの半分」と書いており、
  ADR 0146 が埋めたのは**差し出すほうの半分**である）。
