...
ADR 0288 は、その道筋を実装したものである。**決めたのはオーナー本人の文面ではない**:
オーナーが 2026-09-24T07:02Z に承認キュー経由（repo の外）で「推奨案で良いので、決められる
ものは判断で進めてよい」と委ね、それを受けたオーナーのクローン（価値観の写し）が severity を
足す案に決めた（出自の詳細は ADR 0288「出自」節）。
