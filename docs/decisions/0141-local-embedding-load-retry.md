...
> 本文の「**GitHub の cache API はメタデータしか返さず、内容を取得する経路が無い**」
> （2箇所——「確かめていないこと」の中と §7）は、**この repo に裏づける実測が無い。**
> **【受・未検証】** この ADR は【実測】【現物】【推論】【受領】の4種を冒頭で定義しているが、
> この一文にはそのいずれも付いていない。
> ⚠ **入れ子になっている点に注意。**この一文が現れるのは「確かめていないこと」節の中だが、
> **「確かめていない」の対象は tar の中身であって、この一文自体（＝確かめられない理由）は
> 断定として書かれている。**「確かめていない」と名乗った節の中に、名乗りの無い断定が
> 埋め込まれている形である。
> ⛔ **これは「主張が誤っている」ではない。**GitHub Actions cache API の一般的な制約として
> 広く知られている可能性が高い。⭐ **測っていない、と書くだけである。**（ADR 0219 の掃きで残ったもの）
