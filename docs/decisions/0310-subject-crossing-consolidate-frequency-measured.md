# ADR 0310: Issue #579 の頻度を測った — subject をまたぐ統合は近傍を種の subject に絞れば 0%、絞らなければ使い方しだいで 0〜100%。案 B は採らない
...
> [ADR 0317](./0317-auto-consolidate-scopes-neighbor-search-to-seed-subject.md) に記録した
