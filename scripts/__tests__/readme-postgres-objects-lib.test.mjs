...
describe("deriveMigrationObjects", () => {
  ...
  it("packages/postgres/migrations の現物から導くと、テーブル10・索引23・関数5になる（回帰止め）", async () => {
    ...
    // Issue #201 / ADR 0310: migrations/0020_taxonomy_labels.sql が `labels`/
    ...
    expect(result.indexes).toHaveLength(23);
    expect(result.functions).toEqual([
