 ...
 *
 * ⭐ **これは web の記述だけではない。**【実測 2026-09-21】この門ステップ自身が本番の
 * ランナーで印字した値は `shell: /usr/bin/bash -e {0}` だった（run `35648302199` の
 * job `106494103566` = `examples/chat`。Issue #574 の観測のついでに確かめた）。
 *
